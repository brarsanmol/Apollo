...
public final class DateTimeFormats {
    ...
    public static FastDateFormat HR_MIN_SECS;
    public static FastDateFormat KOTH_FORMAT;
    public static FastDateFormat CURRENT_DATE_FORMAT;
    ...
    public static void reload(TimeZone timeZone) throws IllegalStateException {
        ...
        HR_MIN_SECS = FastDateFormat.getInstance("hh:mm:ss");
        KOTH_FORMAT = FastDateFormat.getInstance("m:ss");
        CURRENT_DATE_FORMAT = FastDateFormat.getInstance("dd MMM yyyy HH:mm:ss", TimeZone.getDefault(), Locale.ENGLISH);
    }
